...
const coalMines = [
  ...
  { id: 11, name: "Korba", state: "Chhattisgarh", x: 49.63, y: 50.2, status: "warning" },
  { id: 12, name: "Singrauli", state: "Madhya Pradesh", x: 49.6, y: 43.49, status: "critical" },
  { id: 13, name: "Kusmunda", state: "Chhattisgarh", x: 49.63, y: 50.28, status: "good" },
  { id: 14, name: "Gevra", state: "Chhattisgarh", x: 49.34, y: 50.24, status: "warning" },
  { id: 15, name: "Dipka", state: "Chhattisgarh", x: 49.2, y: 50.31, status: "critical" },
  { id: 16, name: "Rajmahal", state: "Jharkhand", x: 65.19, y: 40.45, status: "good" },
  { id: 17, name: "Nigahi", state: "Madhya Pradesh", x: 49.53, y: 43.75, status: "warning" },
  { id: 18, name: "Jayant", state: "Madhya Pradesh", x: 49.5, y: 43.71, status: "critical" },
  { id: 19, name: "Dudhichua", state: "Madhya Pradesh", x: 49.57, y: 43.68, status: "good" },
  { id: 20, name: "Khadia", state: "Uttar Pradesh", x: 49.63, y: 43.64, status: "warning" },
  { id: 21, name: "Bina", state: "Uttar Pradesh", x: 49.7, y: 43.6, status: "critical" },
  { id: 22, name: "Kakri", state: "Uttar Pradesh", x: 49.73, y: 43.57, status: "good" },
  { id: 23, name: "Krishnashila", state: "Uttar Pradesh", x: 49.77, y: 43.53, status: "warning" },
  { id: 24, name: "Block B", state: "Madhya Pradesh", x: 49.8, y: 43.49, status: "critical" },
  { id: 25, name: "Ashoka", state: "Jharkhand", x: 57.36, y: 44.77, status: "good" },
  { id: 26, name: "Piparwar", state: "Jharkhand", x: 57.43, y: 44.73, status: "warning" },
  { id: 27, name: "Magadh", state: "Jharkhand", x: 57.5, y: 44.7, status: "critical" },
  { id: 28, name: "Amrapali", state: "Jharkhand", x: 57.56, y: 44.66, status: "good" },
  { id: 29, name: "Chandragupt", state: "Jharkhand", x: 57.63, y: 44.63, status: "warning" },
  { id: 30, name: "Sanghamitra", state: "Jharkhand", x: 57.7, y: 44.59, status: "critical" },
  { id: 31, name: "Pachwara", state: "Jharkhand", x: 65.26, y: 40.38, status: "good" },
  { id: 32, name: "Chuperbhita", state: "Jharkhand", x: 66.69, y: 42.03, status: "warning" },
  { id: 33, name: "Gare Palma", state: "Chhattisgarh", x: 52.37, y: 51.1, status: "critical" },
  { id: 34, name: "Chhal", state: "Chhattisgarh", x: 50.03, y: 50.02, status: "good" },
  { id: 35, name: "Baroud", state: "Chhattisgarh", x: 52.53, y: 50.92, status: "warning" },
  { id: 36, name: "Jampali", state: "Chhattisgarh", x: 52.7, y: 50.74, status: "critical" },
  { id: 37, name: "Bijari", state: "Chhattisgarh", x: 52.87, y: 50.56, status: "good" },
  { id: 38, name: "Samaleswari", state: "Odisha", x: 53.7, y: 52.18, status: "warning" },
  { id: 39, name: "Lajkura", state: "Odisha", x: 53.77, y: 52.11, status: "critical" },
  { id: 40, name: "Lilari", state: "Odisha", x: 53.83, y: 52.04, status: "good" },
  { id: 41, name: "Lakhanpur", state: "Odisha", x: 53.9, y: 51.97, status: "warning" },
  { id: 42, name: "Belpahar", state: "Odisha", x: 53.97, y: 51.89, status: "critical" },
  { id: 43, name: "Ananta", state: "Odisha", x: 57.86, y: 55.22, status: "good" },
  { id: 44, name: "Bharatpur", state: "Odisha", x: 57.93, y: 55.15, status: "warning" },
  { id: 45, name: "Bhubaneswari", state: "Odisha", x: 58, y: 55.08, status: "critical" },
