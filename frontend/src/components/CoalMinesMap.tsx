...
const coalMines = [
  { id: 1, name: "Jharia, Dhanbad", state: "Jharkhand", x: 61.91, y: 45.09, status: "good" },
  { id: 2, name: "Bokaro", state: "Jharkhand", x: 60.1, y: 45.03, status: "warning" },
  { id: 3, name: "Jayanti", state: "Jharkhand", x: 62.87, y: 45.37, status: "critical" },
  { id: 4, name: "Godda", state: "Jharkhand", x: 64.67, y: 41.42, status: "good" },
  { id: 5, name: "Giridih (Karbhari Coal Field)", state: "Jharkhand", x: 61.69, y: 43.57, status: "warning" },
  { id: 6, name: "Ramgarh", state: "Jharkhand", x: 59.28, y: 45.6, status: "critical" },
  { id: 7, name: "Karanpura", state: "Jharkhand", x: 58.28, y: 45.65, status: "good" },
  ...
  { id: 11, name: "Korba", state: "Chhattisgarh", x: 49.64, y: 49.32, status: "warning" },
  { id: 12, name: "Singrauli", state: "Madhya Pradesh", x: 49.95, y: 42.43, status: "critical" },
  { id: 13, name: "Kusmunda", state: "Chhattisgarh", x: 49.97, y: 51.22, status: "good" },
  { id: 14, name: "Gevra", state: "Chhattisgarh", x: 48.46, y: 50.09, status: "warning" },
  { id: 15, name: "Dipka", state: "Chhattisgarh", x: 49.41, y: 50.38, status: "critical" },
  { id: 16, name: "Rajmahal", state: "Jharkhand", x: 64.77, y: 40.42, status: "good" },
  { id: 17, name: "Nigahi", state: "Madhya Pradesh", x: 49.15, y: 44.75, status: "warning" },
  { id: 18, name: "Jayant", state: "Madhya Pradesh", x: 48.83, y: 41.88, status: "critical" },
  { id: 19, name: "Dudhichua", state: "Madhya Pradesh", x: 50.14, y: 44.85, status: "good" },
  { id: 20, name: "Khadia", state: "Uttar Pradesh", x: 48.57, y: 43.92, status: "warning" },
  { id: 21, name: "Bina", state: "Uttar Pradesh", x: 51.4, y: 44.26, status: "critical" },
  { id: 22, name: "Kakri", state: "Uttar Pradesh", x: 48.81, y: 42.88, status: "good" },
  { id: 23, name: "Krishnashila", state: "Uttar Pradesh", x: 50.46, y: 43.9, status: "warning" },
  { id: 24, name: "Block B", state: "Madhya Pradesh", x: 49.51, y: 43.6, status: "critical" },
  { id: 25, name: "Ashoka", state: "Jharkhand", x: 55.99, y: 44.97, status: "good" },
  { id: 26, name: "Piparwar", state: "Jharkhand", x: 58.84, y: 43.85, status: "warning" },
  { id: 27, name: "Magadh", state: "Jharkhand", x: 57.29, y: 45.76, status: "critical" },
  { id: 28, name: "Amrapali", state: "Jharkhand", x: 57.83, y: 43.71, status: "good" },
  { id: 29, name: "Chandragupt", state: "Jharkhand", x: 56.96, y: 44.73, status: "warning" },
  { id: 30, name: "Sanghamitra", state: "Jharkhand", x: 57.96, y: 44.7, status: "critical" },
  { id: 31, name: "Pachwara", state: "Jharkhand", x: 65.74, y: 40.18, status: "good" },
  { id: 32, name: "Chuperbhita", state: "Jharkhand", x: 66.69, y: 42.03, status: "warning" },
  { id: 33, name: "Gare Palma", state: "Chhattisgarh", x: 51.54, y: 51.77, status: "critical" },
  { id: 34, name: "Chhal", state: "Chhattisgarh", x: 50.35, y: 50.04, status: "good" },
  { id: 35, name: "Baroud", state: "Chhattisgarh", x: 53.33, y: 49.62, status: "warning" },
  { id: 36, name: "Jampali", state: "Chhattisgarh", x: 52.39, y: 51.24, status: "critical" },
  { id: 37, name: "Bijari", state: "Chhattisgarh", x: 53.16, y: 50.6, status: "good" },
  { id: 38, name: "Samaleswari", state: "Odisha", x: 53.14, y: 53.17, status: "warning" },
  { id: 39, name: "Lajkura", state: "Odisha", x: 54.9, y: 50.81, status: "critical" },
  { id: 40, name: "Lilari", state: "Odisha", x: 52.84, y: 52.14, status: "good" },
  { id: 41, name: "Lakhanpur", state: "Odisha", x: 54.54, y: 51.75, status: "warning" },
  { id: 42, name: "Belpahar", state: "Odisha", x: 53.8, y: 52.41, status: "critical" },
  { id: 43, name: "Ananta", state: "Odisha", x: 57.22, y: 55.86, status: "good" },
  { id: 44, name: "Bharatpur", state: "Odisha", x: 58.64, y: 54.44, status: "warning" },
