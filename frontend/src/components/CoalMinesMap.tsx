                ...
                {({ zoomIn, zoomOut, resetTransform }) => {
                  ...
                  <div className="relative w-full h-full flex items-center justify-center">
                    ...
                    <div className="absolute top-0 right-0 z-50 flex gap-2 glass-effect p-1.5 rounded-lg border border-white/10">
                      <button onClick={() => zoomIn()} className="w-6 h-6 flex items-center justify-center bg-white/10 rounded hover:bg-white/20 transition-colors text-primary font-bold">+</button>
                      <button onClick={() => zoomOut()} className="w-6 h-6 flex items-center justify-center bg-white/10 rounded hover:bg-white/20 transition-colors text-primary font-bold">-</button>
                    ...
                    <TransformComponent wrapperClass="w-full h-full !flex items-center justify-center" contentClass="w-[120%] max-w-[120%] relative">
                      ...
                      {coalMines.map((mine) => (
                        <div 
                          ...
                          style={{ 
                            left: `${mine.x}%`, 
                            top: `${mine.y}%`,
                            transform: "translate(-50%, -50%) scale(calc(1 / var(--map-zoom, 2.5)))" 
                          }}
                        >
                          <motion.div
