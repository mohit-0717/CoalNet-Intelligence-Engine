...
const coalMines = [
  { id: 2, name: "Bokaro", state: "Jharkhand", x: 60.59, y: 45.03, status: "warning" },
  { id: 3, name: "Raniganj Coalfield", state: "West Bengal", x: 64.46, y: 45.57, status: "warning" },
  { id: 4, name: "Talcher", state: "Odisha", x: 58.13, y: 55.22, status: "warning" },
  { id: 5, name: "Singrauli", state: "Madhya Pradesh", x: 49.57, y: 43.49, status: "warning" },
  { id: 6, name: "Jayanti", state: "Jharkhand", x: 62.36, y: 44.95, status: "critical" },
  { id: 7, name: "Godda", state: "Jharkhand", x: 64.73, y: 41.19, status: "critical" },
  { id: 8, name: "Giridih (Karbhari)", state: "Jharkhand", x: 61.69, y: 43.57, status: "critical" },
  { id: 9, name: "Ramgarh", state: "Jharkhand", x: 59.1, y: 45.57, status: "critical" },
  { id: 10, name: "Karanpura", state: "Jharkhand", x: 57.4, y: 44.92, status: "critical" },
  { id: 11, name: "Daltonganj", state: "Jharkhand", x: 54.27, y: 44.11, status: "critical" },
  { id: 12, name: "Dalingkot (Darjeeling)", state: "West Bengal", x: 69.36, y: 33.22, status: "critical" },
  { id: 13, name: "Birbhum", state: "West Bengal", x: 65.76, y: 44.59, status: "critical" },
  { id: 14, name: "Chinakuri", state: "West Bengal", x: 63.53, y: 45.39, status: "critical" },
  { id: 15, name: "Korba", state: "Chhattisgarh", x: 49.63, y: 50.2, status: "critical" },
  { id: 16, name: "Bishrampur", state: "Chhattisgarh", x: 50.33, y: 47.1, status: "good" },
  { id: 17, name: "Sonhat", state: "Chhattisgarh", x: 49.1, y: 46.15, status: "good" },
  { id: 18, name: "Jhilmil", state: "Chhattisgarh", x: 49.6, y: 46.55, status: "good" },
  { id: 19, name: "Hasdo-Arand", state: "Chhattisgarh", x: 50.17, y: 48.44, status: "good" },
  { id: 20, name: "Jharsuguda", state: "Odisha", x: 54.03, y: 52, status: "warning" },
  { id: 21, name: "Himgiri", state: "Odisha", x: 53.17, y: 51.43, status: "warning" },
  { id: 22, name: "Rampur", state: "Odisha", x: 53.77, y: 52.36, status: "warning" },
  { id: 23, name: "Singareni", state: "Telangana", x: 42.74, y: 67.22, status: "warning" },
  { id: 24, name: "Kothagudem", state: "Telangana", x: 42.81, y: 67.22, status: "warning" },
  { id: 25, name: "Kantapalli", state: "Andhra Pradesh", x: 51.53, y: 64.7, status: "warning" },
  { id: 26, name: "Neyveli", state: "Tamil Nadu", x: 38.97, y: 87.71, status: "warning" },
  { id: 27, name: "Kamptee (Nagpur)", state: "Maharashtra", x: 38.04, y: 54.22, status: "warning" },
  { id: 28, name: "Wun field", state: "Maharashtra", x: 37.21, y: 58.42, status: "warning" },
  { id: 29, name: "Wardha", state: "Maharashtra", x: 36.04, y: 55.97, status: "warning" },
  { id: 30, name: "Ghughus", state: "Maharashtra", x: 37.81, y: 58.85, status: "critical" },
  { id: 31, name: "Warora", state: "Maharashtra", x: 37.38, y: 57.78, status: "good" },
  { id: 32, name: "Ledo", state: "Assam", x: 93.11, y: 32.1, status: "good" },
  { id: 33, name: "Makum", state: "Assam", x: 92.18, y: 31.28, status: "good" },
  { id: 34, name: "Najira", state: "Assam", x: 89.78, y: 33.49, status: "good" },
  { id: 35, name: "Janji", state: "Assam", x: 88.94, y: 33.71, status: "good" },
  { id: 36, name: "Jaipur", state: "Assam", x: 91.98, y: 32.18, status: "good" },
  { id: 37, name: "Darrangiri (Garo hills)", state: "Meghalaya", x: 76.29, y: 38.98, status: "good" },
  { id: 38, name: "Cherrapunji", state: "Meghalaya", x: 79.78, y: 39.61, status: "good" },
  { id: 39, name: "Liotryngew", state: "Meghalaya", x: 79.72, y: 39.53, status: "good" },
  { id: 40, name: "Maolong", state: "Meghalaya", x: 79.62, y: 39.75, status: "good" },
  { id: 41, name: "Langrin coalfields", state: "Meghalaya", x: 77.78, y: 39.68, status: "good" },
  { id: 42, name: "Sohagpur", state: "Madhya Pradesh", x: 45.2, y: 46.73, status: "good" },
  { id: 43, name: "Johila", state: "Madhya Pradesh", x: 44.17, y: 46.55, status: "good" },
  { id: 44, name: "Umaria", state: "Madhya Pradesh", x: 43.51, y: 45.94, status: "good" },
  { id: 45, name: "Satpura coalfield", state: "Madhya Pradesh", x: 34.61, y: 50.82, status: "warning" },
];
